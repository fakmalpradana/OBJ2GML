...
class CityGMLMerger:
    ...
    def create_merged_citygml(self, file_paths, output_name="Merged_CityModel"):
        """
    ...
    def merge_files(self, input_directory, output_file, output_name="Merged_CityModel"):
        """
        ...
        try:
            ...
            merged_tree = self.create_merged_citygml(valid_files, output_name)
...
The --name parameter will be used as:
  1. The name of the merged CityModel
  2. The prefix to replace "UUID_" in all building IDs
  
Example: UUID_d281adfc-4901-0f52-540b-48625 becomes AG_09_C_d281adfc-4901-0f52-540b-48625
        """
    )
    ...
    merger.merge_files(args.input_directory, args.output_file, args.name)
